...
import com.hai.yun.cloudonfoot.views.PieView
 ...
 * [WarningListFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [WarningListFragment.newInstance] factory method to
...
//            throw RuntimeException(context.toString() + " must implement OnFragmentInteractionListener")
    ...
    companion object {
         ...
         * @return A new instance of fragment WarningListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WarningListFragment().apply {
